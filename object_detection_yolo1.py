...
def cropBoundingBox(frame, left, right, top, bottom, basePath="images/"):
    cropped_image = frame[top:bottom, left:right]
    cv.imwrite(basePath+str(int(time.time()))+".jpg", cropped_image)
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        width = box[2]
        height = box[3]
        cropBoundingBox(frame, left, left + width, top, top + height)
